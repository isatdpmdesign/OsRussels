# Ficha de Continuidade — Os Russels

> Índice rápido. **Não substitui o texto.** Para citar um fato, sempre confirmar no capítulo (cita `arquivo:linha`). Atualizar ao fechar cada capítulo.

## Idades (agosto 1830, presente da história)
...
| Dylan Russel | 19 | `cap02:17`, `cap20:143`, `biblia:69` |
| Matias Russel | 13 | `cap02:15`, `cap20:169,199,459` |
| Casandra Russel | ~48 (inferido: 17 ao se casar + 26 anos de casamento + viúva há 4 + 1 a 2 anos de espera entre os pedidos) | `cap23` |
...
## Descrições físicas (síntese)

- **Aurora**: mestiça indo-dinamarquesa, ~1,61m, pele âmbar-bronze, cabelos grossos escuros ondulados até meio das costas, olhos castanho-mel/âmbar (dourados ao sol), lábios cheios, cheiro de **jasmim e canela** | `biblia:114-122`
- **Josh**: dinamarquês, ~1,80m, **loiro quase ruivo**, olhos verdes que ficam alaranjados, barba loira-alaranjada, corpo de trabalho no campo, **mãos brutas** (calo de machado, nó dos dedos com arranhão antigo da pérgola de maio), sorriso torto "cara de idiota satisfeito" | `biblia:67`, `cap05:147,189`, `cap02:165`
- **Joseph**: **ruivo de verdade** (mais ruivo que Josh, cabelo e barba puxados pra cobre), **olhos azuis**, mais alto que Josh, mais quadrado nos ombros, sério-respeitoso, "homem da casa" | `cap22:97` (corrigido)
- **Meridiana**: loira, cabelo preso meio caindo, olhos verdes (mesmo verde de Josh, mais claros), descalça no pomar, **cheiro de maçã e terra molhada** | `cap02:49`, `cap22`
- **Dylan**: cabelos loiros escuros bagunçados, olhos verdes, **riso seco do pai (Henrik)**, canivete afiadíssimo | `cap20:143`, `cap22`
- **Matias**: **loiríssimo (loiro de criança, quase branco no sol), olhos azuis tão claros que de longe parecem cinza**, magro, descalço | `cap22` (corrigido)
- **Casandra**: cabelos castanhos presos com lenço azul-claro, mãos vermelhas de cozinha, avental gasto, não chora em público | `cap22`, `biblia:55`
- **Raj**: pele cor de terra molhada, olhos escuros como café, cabelos negros prateando nas têmporas, ~aristocrático | `biblia:81`
- **Eleonora**: loira, cabelos finos, pálida como porcelana, olhos azuis, precisão nórdica | `biblia:92`

## Timeline canônica

| Evento | Quando | Fonte |
|---|---|---|
| Sociedade comercial Henrik–Raj | Anos 1810 | `biblia:288` |
| Morte do Henrik | ~4 anos antes, Matias com 9 | `cap02:39`, `cap20:199` |
| Casandra escreve carta selada a Raj | Antes da viagem do Josh, março | `cap02:255` |
| Anúncio chegada do Josh | Março de 1830 | `cap01` |
| Josh chega à Bredgade | Abril de 1830 | `cap02` |
| Cap 5: pérgola escorada | Maio de 1830 | `cap05` |
| Cap 6: baile dos Frederiksen (debut Aurora) | Junho de 1830 | `cap06` |
| Cap 9: sarau dos Holst, Erik entra | Junho/julho de 1830 | `cap09` |
| Cap 15: festa do celeiro (Eriksen, Christianshavn) | Sexta de agosto | `cap15` |
| Cap 16: 4 dias depois — jantar Mortensen + anúncio Vibeke | Quarta seguinte | `cap16` |
| Cap 17: Vibeke chega, 11:15 | Quarta seguinte | `cap17` |
| Cap 18: baile dos Lundgren, Frederiksberg | Quinta | `cap18` |
| Cap 19: madrugada da sala de estar (1º beijo) | 00:10 sexta | `cap19` |
| Cap 20: cozinha 5:45 + biblioteca 9h (dívida) | Sexta | `cap20` |
| Cap 21: anúncio da viagem; partida segunda 4:30 | Quinta + segunda | `cap21` |
...
**Bredgade (Copenhague):** rua elegante, casarão tijolo vermelho, frontão neoclássico, aldrava de leão. Quarto leste = quarto do Josh, com escrivaninha de mogno. Biblioteca (cap03,09,19), sala de estar (cap19, beijo), sala de costura, cozinha de Fru Larsen, sala de música (cravo Eleonora). Jardim: pérgola de glicínias, banco do Aarav, roseiras no canto direito, cascalho branco. Décimo segundo degrau range (reforma 1827).

**Sorø (Russel):** propriedade rural na Zelândia, perto da cidade de Sorø. Pedra na metade de baixo, madeira escurecida em cima, **telhado de palha reconstruído 3 vezes pelo Henrik**. Celeiro à esquerda. **Pomar de macieiras à direita** (Berta = macieira velha perto do tanque, com quem Meridiana conversa). **14 vacas, 3 cabras, 2 cães (Kongen velho + Liv jovem mordedora)**. Lago no lado norte (acesso atrás do pomar, mato alto, parte arborizada, lado fundo ~2,5m). Cerca do pasto norte. Cardo-de-Maria no caminho do lago. Quarto da Meridiana cedido pra Aurora+Vibeke (Meridiana dorme com a Casandra). Cadeira do Henrik à cabeceira da mesa, intocada, Casandra passa a mão no encosto antes de sentar | `cap02:49,223`, `cap20:131`, `cap21:141`, `cap22-24`

**Casa comercial (sem nome) na Højbro, Copenhague:** onde o depósito conjunto Henrik–Raj fica travado | (plano Cap 28)

**Regensen:** residência estudantil universitária, regras estritas de visita feminina | `biblia:39`, (plano Cap 26)
...
- **Berta** — macieira velha do pomar Russel, perto do tanque. Meridiana conversa com ela | `cap20:151-155`
- **Canivete do Dylan** — afiadíssimo, lâmina mais fina que a do pai | `cap20:143`
- **Coleção de poesia do Henrik** — guardada na casa Russel, "ninguém olha mais" (Matias quer mostrar pra Aurora) | `cap22`
- **Camisa de gola alta do Josh com bordado da Casandra na lapela** — peça emblemática | `biblia:244`
- **Caneca lascada do Josh** — manhãs 5:45 na cozinha da Bredgade | `cap10:21`, `cap13:25`, `cap14`
- **Cobertor de retalhos** + colcha de retalhos do quarto da Meridiana em Sorø | `cap22:175`
- **Botinha fina de salão da Aurora em Sorø** — ela jurou tirar "amanhã" no pomar do Cap 22, não tirou em 10 dias; o lago tirou pra ela no Cap 24 | `cap22`, `cap24`
- **Pano com iniciais A.S. bordado pela Casandra pra Aurora**, **muda de macieira da Meridiana**, **livro de poesia do Henrik do Matias** — presentes-senha da partida | (plano Cap 25)

## Lugares-senha (carregam memória)

- **Sala de estar da Bredgade**: 1º beijo, madrugada (`cap19`). Eco no Cap 28 (noivado).
- **Banco da pérgola/glicínias**: território da Aurora, lugar de cuidado silencioso do Josh (`cap05`).
- **Cozinha da Bredgade 5:45**: encontros silenciosos pré-Vibeke, depois da madrugada do beijo (`cap20`).
- **Festa do celeiro em Christianshavn**: senha do quase-beijo do Cap 15 (Raj e Eleonora NÃO sabem que existiu).
- **Bosque do pasto norte em Sorø, sob o carvalho**: beijo decisor (`cap23`).
- **Berta** (macieira velha): território Meridiana, símbolo de luto que se acomoda.
- **Cadeira do Henrik** (Sorø) ⇄ **cadeira do Aarav** (Bredgade): espelhamento de lutos. Casandra passa a mão; Eleonora não.

## Quem sabe o quê (mapa de informação)
...
- **Cheiro da Aurora**: jasmim e canela
- **Cheiro do Josh**: tabaco, ar frio, sabão de Copenhague (na Bredgade); terra, palha, maçã madura, fumaça de fogão (em Sorø — o cheiro de "fundo" dele)
- **Cheiro da Meridiana**: maçã e terra molhada
- **Manhã 5:45**: horário das primeiras manhãs Aurora-Josh na cozinha da Bredgade
- **Décimo segundo degrau**: range, reforma 1827
...
- *"Não me cabia perguntar."* (Josh, cap19)
- *"Você é a minha filha."* (Eleonora pra Aurora, cap21:327)
- *"Cuida da Vibeke. Você é mais ajuizada do que ela."* (Eleonora, cap21:319)
- *"O Josh escreveu sobre você."* (Meridiana pra Aurora, cap22)
- *"Você cabe aqui se quiser, menina."* (Casandra pra Aurora, cap23)
- *"Filho, você não é um miserável."* (Casandra pro Josh, cap23)
- *"Você não tem um osso desonesto no corpo."* (Joseph pro Josh, cap23)
- *"Eu vou casar com você."* (Aurora pro Josh, cap24)
- *"Não sai do meu olho."* (Josh pra Aurora sobre o lago, cap24)
- **Eco recorrente**: *"como quem comenta o clima"* (Josh sobre Dylan, cap20:143) — **NÃO RECICLAR em outros POVs**. Cada personagem cria a régua própria.

## A blacklist e a régua

Ver `decisoes-editoriais.md`.
...
- **Eleonora sabia de tudo** — não por boca de ninguém, mas por reparar sozinha: a atmosfera/química entre Aurora e Josh, e o dia da contestação da Vibeke na sala (viu o rosto dos dois no mesmo segundo, cap27). *"Eu não vejo pra dizer. Eu vejo pra guardar."* **Helle NÃO delatou** (é cúmplice da Aurora); Eleonora soube da saída noturna porque tem sono leve e **viu Aurora sair e voltar pela janela do corredor** (madrugada do Regensen). Não sabia do dinheiro/herança do Josh (Aurora conta na cena). `cap33` *(revisado na rodada da autora)*
